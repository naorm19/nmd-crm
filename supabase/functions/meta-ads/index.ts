...
חשוב: אל תסיק מסקנות מכמות רכישות קטנה. מודעה/קמפיין עם רכישה אחת או שתיים ב-9 ש"ח לא "יותר טובה" ממודעה עם רכישה אחת ב-90 ש"ח - זה יכול להיות מקרי לגמרי, לא מגמה. השווה עלות-לרכישה בין שני דברים רק אם לשניהם יש לפחות 3 רכישות; אחרת תגיד במפורש שאין מספיק רכישות כדי להשוות, ותציין כמה רכישות יש בפועל.
